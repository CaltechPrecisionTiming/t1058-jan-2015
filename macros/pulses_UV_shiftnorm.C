...
{
	TFile * f1 =  new TFile("~/LabData/Zhicai_Spring2018/data/1104_ana_withpulse.root");
	TTree * t1 = (TTree*)f1->Get("tree");

	TFile * f2 =  new TFile("~/LabData/Zhicai_Spring2018/data/1106_ana_withpulse.root");
	TTree * t2 = (TTree*)f2->Get("tree");

	TFile * f3 =  new TFile("~/LabData/Zhicai_Spring2018/data/1108_ana_withpulse.root");
	...
	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_373nm_norm.pdf");
	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_373nm_norm.png");
	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_373nm_norm.C");
