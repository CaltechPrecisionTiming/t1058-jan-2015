...
// Fri Apr  7 20:41:24 2017 by ROOT version 6.08/00
// from TTree tree/tree
// found on file: 1x1mm_SiPMon_71V_PhotekOn_3p5kV_AmpOff_LaserOn_Tune30_ND0p3_ANA.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     Loop(int amp, int Att, char* ND, float left_ch1, float right_ch1);
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("1x1mm_SiPMon_71V_PhotekOn_3p5kV_AmpOff_LaserOn_Tune30_ND0p3_ANA.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("1x1mm_SiPMon_71V_PhotekOn_3p5kV_AmpOff_LaserOn_Tune30_ND0p3_ANA.root");
      }
