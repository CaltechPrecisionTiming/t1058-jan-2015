...
void ArgonneStriplineAnalysis() {

  //*************************************
  // Photocathode ON Vs Shower Depth
  //*************************************
  MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_36.ana_lowpassfilter.root","PhotonisPhotocathodeON_Electron_NoAbsorber_8GeV", 1.0, 0.03, 0.3);
