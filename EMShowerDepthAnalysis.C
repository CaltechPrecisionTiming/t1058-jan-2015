...
void MakeAmplitudeVsShowerDepthGraph() {
  ...
  float y_lead_SetOne[4] = {  0.27, 0.41, 0.32, 0.06 };
  ...
  float y_lead_SetTwo[3] = {  0.32, 0.17, 0.11  };
  ...
  float y_tungsten_SetTwo[3] = {  0.35, 0.15, 0.06};
  float yerr_tungsten_SetTwo[3] = { 0.01, 0.01, 0.01 };

  //we normalized SetTwo to SetOne in 2 different situations.
  //For 2X0 tungsten, we get a scaling factor of 0.44/0.35 to go from Set2 to Set1
  //For 4X0 lead, we got a scaling factor of 0.32/0.32 to go from Set2 to Set1
  
  //If we use the average scaling factor from both runs, we get the following results
  //scaling factor = 1.1286
  float x_lead_combined[6] = { 2.5, 4.5, 6.5, 8.5, 10.5, 12.5 };
  float xerr_lead_combined[6] = { 0.25,0.25, 0.25, 0.25, 0.25, 0.25 };
  float y_lead_combined[6] = {  0.27, 0.41, 0.36, 0.19, 0.12, 0.06  };
  float yerr_lead_combined[6] = { 0.01, 0.01, 0.01, 0.01, 0.01, 0.01 };
  float x_tungsten_combined[6] = { 2.5, 4.5, 6.5, 8.5, 10.5, 12.5 };
  float xerr_tungsten_combined[6] = { 0.25, 0.25, 0.25, 0.25 , 0.25, 0.25};
  float y_tungsten_combined[6] = {  0.27, 0.40, 0.35, 0.24, 0.17, 0.07 };
  float yerr_tungsten_combined[6] = { 0.01, 0.01, 0.01, 0.01, 0.01, 0.01 };

  //If we use the scaling factor obtained from the runs with 2X0 tungsten, we
  //get the following results (scaling factor = 1.2571)  
  // float x_lead_combined[6] = { 2.5, 4.5, 6.5, 8.5, 10.5, 12.5 };
  // float xerr_lead_combined[6] = { 0.25,0.25, 0.25, 0.25 };
  // float y_lead_combined[6] = {  0.27, 0.41, 0.32, 0.17, 0.11, 0.06  };
  // float yerr_lead_combined[6] = { 0.01, 0.01, 0.01, 0.01, 0.01, 0.01 };
  // float x_tungsten_combined[6] = { 2.5, 4.5, 6.5, 8.5, 10.5, 12.5 };
  // float xerr_tungsten_combined[6] = { 0.25, 0.25, 0.25 };
  // float y_tungsten_combined[6] = {  0.27, 0.44, 0.35, 0.24, 0.19, 0.08 };
  // float yerr_tungsten_combined[6] = { 0.01, 0.01, 0.01, 0.01, 0.01, 0.01 };
...
void MakeTimeResolutionVsShowerDepthGraph() {
  ...
  // float y_lead[4] = { 11.6 , 12.9  , 14.0 , 16.8    };
  ...
  float x_tungsten_combined[6] = { 2.5, 4.5, 6.5, 8.5, 10.5, 12.5 };
  float xerr_tungsten_combined[6] = { 0.25 , 0.25, 0.25, 0.25, 0.25, 0.25 };
  float y_tungsten_combined[6] = { 11.6 , 13.2 , 14.3 , 12.1, 13.3, 13.6 };
  float yerr_tungsten_combined[6] = { 0.4 , 0.4 , 0.6 , 0.5, 0.5, 0.5 };

  float x_lead_SetOne[4] = { 2.5, 4.5, 6.5, 12.5 };
  float xerr_lead_SetOne[4] = { 0.25,0.25, 0.25, 0.25 };
  float y_lead_SetOne[4] = { 11.6 , 12.9  , 14.0 , 16.8 };
  ...
  float x_lead_combined[6] = { 2.5, 4.5, 6.5, 8.5, 10.5, 12.5 };
  float xerr_lead_combined[6] = { 0.25,0.25, 0.25, 0.25, 0.25, 0.25 };
  float y_lead_combined[6] = { 11.6 , 12.9  , 13.1 , 12.9 , 12.4 , 16.8 };
...
void EMShowerDepthAnalysis() {
  ...
  //*************************************
  //MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_4.root.ana_lowpassfilter.root","Amplitude_Electron_NoAbsorber_8GeV", 1.0, 0.1, 0.45);
  //MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_5.root.ana_lowpassfilter.root","Amplitude_Electron_2X0Lead_8GeV", 3.162, 0.05, 0.2);
  //MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_6.root.ana_lowpassfilter.root","Amplitude_Electron_4X0Load_8GeV",3.162, 0.02,0.45 );
  //MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_7.root.ana_lowpassfilter.root","Amplitude_Electron_10X0Lead_8GeV", 1.0, 0.00, 0.1);

  //MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_8.root.ana_lowpassfilter.root","Amplitude_Electron_2X0Tungsten_8GeV", 3.162, 0.05, 0.2);
  //MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_9.root.ana_lowpassfilter.root","Amplitude_Electron_4X0Tungsten_8GeV",3.162, 0.02,0.45 );
  //MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_10.root.ana_lowpassfilter.root","Amplitude_Electron_6X0Tungsten_8GeV", 1.0, 0.00, 0.4);

  // MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_68.root.ana_lowpassfilter.root","Amplitude_Electron_4X0Lead_8GeV", 3.162, 0.05, 0.2);
  // MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_69.root.ana_lowpassfilter.root","Amplitude_Electron_6X0Lead_8GeV", 3.162, 0.02, 0.2);
  //MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_70.root.ana_lowpassfilter.root","Amplitude_Electron_6X0Lead_8GeV", 1.0, 0.02, 0.4);
  // MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_71.root.ana_lowpassfilter.root","Amplitude_Electron_8X0Lead_8GeV", 1.0, 0.02, 0.4);

  // MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_67.root.ana_lowpassfilter.root","Amplitude_Electron_2X0Tungsten_8GeV", 3.162, 0.05, 0.2);
  // MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_65.root.ana_lowpassfilter.root","Amplitude_Electron_8X0Tungsten_8GeV", 1.0, 0.02, 0.4);
  // MakeAmplitudePlot("/uscms_data/d2/sxie/releases/CMSSW_7_2_3/src/Timing/t1058-jan-2015/t1058_jan2015_run_66.root.ana_lowpassfilter.root","Amplitude_Electron_10X0Tungsten_8GeV", 1.0, 0.02, 0.4);
